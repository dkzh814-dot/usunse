  ...
  return (
    <main className="min-h-screen px-4 py-10 max-w-sm mx-auto space-y-8">
      ...
      <div className="text-center space-y-1">
        <p className="text-xs uppercase tracking-widest text-accent">Five Elements Analysis</p>
      ...
      <div className="bg-surface border border-border rounded-2xl p-5">
        <StreamingAnalysis name={name} dob={dob} hour={hour} tier="fiveElements" />
      </div>
    </main>
  );
}
