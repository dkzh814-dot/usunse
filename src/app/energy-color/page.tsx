...
export default function EnergyColorPage() {
  return (
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col gap-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-display font-bold text-text leading-tight">
            What's your<br />energy color?
          </h1>
          <p className="text-sm text-muted leading-relaxed">
            Your chart holds a color — a frequency that describes how you move through the world.
          </p>
        </div>

        <BirthForm destination="/energy-color-result" showHour={false} />
      </div>
    </main>
  );
}
